...
<aside id="default-sidebar"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-neutral-900 border-e border-default text-neutral-200">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/dashboard"
                   class="nav-link flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group <?php echo isActive('/dashboard', $currentPath) ?>">
        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="/gcodes"
                   class="nav-link flex items-center px-2 py-1.5 text-body rounded-base hover:bg-neutral-tertiary hover:text-fg-brand group <?php echo isActive('/gcodes', $currentPath) ?>">
